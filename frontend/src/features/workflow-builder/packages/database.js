    ...
    'db:upsert': {
      ...
      parameters: [
        ...
        },
        {
          ...
          default: 'auto',
          options: [
            { value: 'auto', label: 'Auto-detect (ip_address, ping_status)' },
            { value: 'columns', label: 'Specify Columns' },
            { value: 'mapping', label: 'Custom Field Mapping' },
          ],
          help: 'How to map input fields to database columns',
        },
        {
          id: 'columns',
          type: 'text',
          label: 'Columns to Use',
          default: 'ip_address,ping_status',
          showIf: { field: 'mapping_mode', value: 'columns' },
          help: 'Comma-separated list of columns (input field name = db column name)',
        },
        {
          id: 'column_mapping',
          type: 'column-mapping',
          label: 'Field Mapping',
          default: [],
          showIf: { field: 'mapping_mode', value: 'mapping' },
          help: 'Map input fields to database columns',
        },
      ],
