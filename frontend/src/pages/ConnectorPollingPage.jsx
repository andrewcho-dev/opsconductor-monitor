                  ...
                  <td className="px-4 py-3">
                    {editing === connector.id ? (
                      <div className="flex items-center gap-2">
                        <input
                          type="number"
                          defaultValue={connector.config?.poll_interval || 60}
                          className="w-20 px-2 py-1 border rounded text-sm"
                          id={`poll-interval-${connector.id}`}
                        />
                        <span className="text-sm text-gray-500">seconds</span>
                        <button
                          onClick={() => {
                            const interval = document.getElementById(`poll-interval-${connector.id}`).value;
                            updatePollInterval(connector.id, interval);
                          }}
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() => setEditing(connector.id)}
